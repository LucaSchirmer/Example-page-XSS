<html>
  ...
  <body>
    <div class="inhalt">
      <h1 class="hl1"> Beispiel Block </h1>
      <article>
        <p class="text">
    ...
    <div class="comment-section"> 
     <?php
      ...
      $_load = $conn->query("SELECT * FROM kommentare ORDER BY id DESC");
      while($_data =  $_load->fetch_object()){
        echo "
        <div class='kommentar-div-grid'>
        <h1 class='kommentar-h1' style='
        font-size: 2.5rem;    
        place-self: center;
        text-align: center;  
        '>
    ...
    <br>
    <br>
    <form action="" method="POST" class="KommentarForm">
      <div class="form-kommentar">
